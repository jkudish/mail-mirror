...
`jkudish/mail-mirror`, with Pull requests read and Commit statuses read/write.
Metadata access is implicit; Contents access is not needed. Candidate
verification never receives this token.
