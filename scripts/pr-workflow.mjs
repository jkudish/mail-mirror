...
export const CHECK_STEPS = Object.freeze([
    ...
    { command: 'bash', args: ['scripts/test-compatibility.sh', '12', 'stable'] },
    { command: 'bash', args: ['scripts/test-compatibility.sh', '12', 'lowest'] },
    { command: 'bash', args: ['scripts/test-consumer-install.sh', '13'] },
    ...
    { command: 'bash', args: ['-n', 'scripts/test-compatibility.sh'] },
